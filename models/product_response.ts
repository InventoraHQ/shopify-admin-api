...
import { ProductVariantResponse } from './product_variant_response';
import { ShopifyObjectResponse } from './base_response';

export interface Product extends ShopifyObjectResponse {
    /** 
